...
export const esES: LocalizationResource = {
	...
	formFieldHintText__slug:
		'Un slug es un ID legible que debe ser único. Es comúnmente usado en URLs.',
	...
	formFieldInputPlaceholder__organizationDomain:
		'Ingrese el dominio de la organización',
	formFieldInputPlaceholder__organizationDomainEmailAddress:
		'Ingrese un correo electrónico del dominio',
	formFieldInputPlaceholder__organizationName:
		'Ingrese el nombre de la organización',
	formFieldInputPlaceholder__organizationSlug:
		'Ingrese un slug único para la organización',
	...
	formFieldLabel__automaticInvitations:
		'Activar invitaciones automáticas para este dominio',
	...
	formFieldLabel__organizationDomainDeletePending:
		'Borrar invitaciones y sugerencias pendientes',
	...
	organizationProfile: {
		...
		profilePage: {
			dangerSection: {
				deleteOrganization: {
					actionDescription:
						'Escriba "{{organizationName}}" a continuación para continuar.',
		...
		removeDomainPage: {
			...
			messageLine2:
				'Los usuarios no podrán unirse a la organización automáticamente después de esto.',
		...
		verifiedDomainPage: {
			dangerTab: {
				calloutInfoLabel:
					'La eliminación de este dominio afectará a los usuarios invitados.',
				removeDomainActionLabel__remove: 'Eliminar dominio',
				removeDomainSubtitle:
					'Elimine este dominio de sus dominios verificados',
			...
			enrollmentTab: {
				...
				calloutInfoLabel:
					'Cambiar el modo de inscripción solo afectará a nuevos usuarios.',
				calloutInvitationCountLabel:
					'Invitaciones pendientes enviadas a los usuarios: {{count}}',
				calloutSuggestionCountLabel:
					'Sugerencias pendientes enviadas a los usuarios: {{count}}',
				...
				subtitle:
					'Elija cómo los usuarios de este dominio pueden unirse a la organización.',
			},
			start: {
			...
			subtitle:
				'El dominio {{domain}} está ahora verificado. Continúe seleccionando el modo de inscripción.',
			title: 'Actualizar {{domain}}',
		},
		verifyDomainPage: {
			formSubtitle:
				'Ingrese el código de verificación enviado a su dirección de correo electrónico',
			formTitle: 'Código de verificación',
			resendButton: '¿No recibió un código? Reenviar',
			subtitle:
				'El dominio {{domainName}} necesita ser verificado por correo electrónico.',
	...
	reverification: {
		alternativeMethods: {
			...
			subtitle:
				'Selecciona uno de los métodos disponibles para verificar tu identidad.',
		...
		noAvailableMethods: {
			message:
				'Lo sentimos, no tienes ningún método de verificación disponible. Contacta con soporte.',
		...
		phoneCodeMfa: {
			...
			resendButton: 'Reenviar código',
			subtitle:
				'Introduce el código de verificación de dos factores enviado a tu teléfono.',
			title: 'Verificación por teléfono (2FA)',
		},
		totpMfa: {
			formTitle: 'Código TOTP',
			subtitle:
				'Introduce el código de autenticación TOTP para completar la verificación.',
	...
	signIn: {
		...
		alternativeMethods: {
			...
			subtitle:
				'¿Tienes problemas? Puedes usar cualquiera de estos métodos para iniciar sesión.',
		...
		emailLink: {
			clientMismatch: {
				subtitle:
					'El cliente no coincide con el solicitado. Por favor, intente de nuevo.',
		...
		forgotPassword: {
			...
			subtitle_email:
				'Primero, introduce el código enviado a tu correo electrónico',
		...
		resetPassword: {
			...
			requiredMessage:
				'Por razones de seguridad, se requiere restablecer su contraseña.',
			successMessage:
				'Tu contraseña ha sido cambiada exitosamente. Iniciando sesión, por favor espera un momento.',
			title: 'Establecer nueva contraseña',
		},
		resetPasswordMfa: {
			detailsLabel:
				'Necesitamos verificar tu identidad antes de restablecer tu contraseña.',
		},
		start: {
			...
			actionLink__use_email_username:
				'Usar correo electrónico o nombre de usuario',
	...
	signUp: {
		...
		emailLink: {
			clientMismatch: {
				subtitle:
					'Parece que no estás usando el dispositivo correcto para verificar tu cuenta.',
		...
		restrictedAccess: {
			...
			subtitle:
				'El acceso a esta funcionalidad está restringido en este momento.',
			subtitleWaitlist:
				'Te has unido a la lista de espera. Nos pondremos en contacto contigo pronto.',
	...
	unstable__errors: {
		...
		form_identifier_not_found:
			'No se ha encontrado ninguna cuenta con este identificador.',
		...
		form_param_format_invalid__phone_number:
			'El número de teléfono debe estar en un formato internacional válido.',
		...
		form_param_max_length_exceeded__last_name:
			'El apellido no debe exceder los 256 caracteres.',
		...
		form_password_pwned:
			'Tu contraseña ha sido comprometida en una violación de seguridad.',
		form_password_pwned__sign_in:
			'La contraseña ya está en uso en otro servicio.',
		...
		organization_domain_blocked:
			'Este es un dominio bloqueado, por favor usa otro.',
		...
		passkey_pa_not_supported:
			'La clave de acceso no es compatible con la autenticación de dispositivos.',
		passkey_registration_cancelled:
			'El registro de la clave de acceso fue cancelado.',
		passkey_retrieval_cancelled:
			'La recuperación de la clave de acceso fue cancelada.',
		passwordComplexity: {
		...
		phone_number_exists:
			'Este número de teléfono ya está en uso. Por favor, inténtelo con otro.',
		session_exists: 'Ya has iniciado sesión',
		web3_missing_identifier: undefined,
		zxcvbn: {
			couldBeStronger: undefined,
			goodPassword: 'Su contraseña cumple con todos los requisitos necesarios.',
			notEnough: undefined,
			suggestions: {
	...
	userProfile: {
		...
		profilePage: {
			...
			readonly:
				'La información de su perfil ha sido proporcionada por la conexión empresarial y no puede ser editada.',
	...
	waitlist: {
		...
		success: {
			...
			subtitle:
				'Recibirás una invitación para unirte cuando haya espacio disponible.',
